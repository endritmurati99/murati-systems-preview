...
- **Visitenkarte und Projekte (25.09.2026 abends):** `.id-actions` zeigt WhatsApp über die volle Breite, darunter E-Mail und den quadratischen LinkedIn-Knopf `.id-li`. Unter Dautibau steht ESD Bau als `.project-next` mit Mini-Laptop (`assets/kunde-esd-desktop.webp`, Entwurf V3 aus dem Designvergleich) und ehrlichem Status. Vorschaubild beim Teilen: `assets/og-image-v2.jpg` (Website am Laptop und Handy; Kopie und Google-Titelbild in `brand/`).
